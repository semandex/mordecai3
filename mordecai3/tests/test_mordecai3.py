...
def test_similar_result(geo):
    ...
    first_search_res = [e['search_name'] for e in res1['geolocated_ents']]
    text2 = """
    ...
    second_search_res = [e['search_name'] for e in res2['geolocated_ents']]
    assert len(res1['geolocated_ents']) == len(res2['geolocated_ents'])
